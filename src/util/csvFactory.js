...
import $ from 'jquery';
var csv = $.csv = require('../../node_modules/jquery-csv/src/jquery.csv.js');
var data = require('../../TechRadar.csv');

// get csv data from file
// but how????

// convert csv data into an array of objects
const rawDataTable = csv.toArrays(data);
console.log('datatable: ', rawDataTable);
